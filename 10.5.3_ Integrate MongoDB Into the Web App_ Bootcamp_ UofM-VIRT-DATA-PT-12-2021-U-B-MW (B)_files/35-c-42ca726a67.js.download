(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[35],{"+oik":function(e,t,n){"use strict"
...
var lt=ct(st)
var dt=lt.StyleSheet,ut=lt.StyleSheetServer,xt=lt.StyleSheetTestUtils,_t=lt.css,mt=lt.minify,pt=lt.flushToStyleTag,ft=lt.injectAndGetClassName,ht=lt.defaultSelectorHandlers,yt=lt.reset,bt=lt.resetInjectedStyle},"01jY":function(e,t,n){o=function(e,t){"use strict"
...
const Et=["trayProps"]
var At,St,jt,It
const Tt=s.a.lazy(()=>n.e(4141).then(n.bind(null,"L5Z7")))
const Lt=s.a.lazy(()=>Promise.all([n.e(3668),n.e(4109)]).then(n.bind(null,"GuXJ")))
const Bt=250
const Dt="400px"
...
this.a11yCheckerReady=Promise.all([n.e(11),n.e(22),n.e(23),n.e(26),n.e(27),n.e(4096)]).then(n.bind(null,"sOmF")).then(e=>{e.default(this.language)
...
this.ltiToolFavorites.length>0&&n.e(3688).then(n.bind(null,"DiQt"))
...
n.d(t,"a",(function(){return Qn}))
n.d(t,"b",(function(){return eo}))
var o=n("ODXe")
var i=n("VTBJ")
var r=n("Ff2n")
var a=n("q1tI")
...
const j="action.images.add_image"
const I="action.images.request_initial_images"
const T="action.images.request_images"
const L="action.images.receive_images"
const B="action.images.fail_images_load"
function D({id:e,filename:t,display_name:n,url:o,thumbnail_url:i},r){return{type:j,payload:{newImage:{id:e,filename:t,display_name:n,preview_url:o,thumbnail_url:i},contextType:r}}}function R(e){return{type:I,payload:{contextType:e}}}function F(e){return{type:T,payload:{contextType:e}}}function M({response:e,contextType:t,opts:n={}}){const o=e.files,i=e.bookmark,r=e.searchString
return{type:L,payload:{files:o.map(e=>P(e,n)),bookmark:i,contextType:t,searchString:r}}}function z({error:e,contextType:t}){return{type:B,payload:{error:e,contextType:t}}}const P=(e,t)=>{const n=Object(i["a"])({},e)
if(t.category===S["c"]){n[S["a"]]=true
n[S["b"]]=e.download_url}return n}
function N(e={}){const t=e.category
return(n,o)=>{const r=o()
return r.source.fetchImages(Object(i["a"])(Object(i["a"])({},r),{},{category:t})).then(t=>n(M({response:t,contextType:r.contextType,opts:e}))).catch(e=>n(z({error:e,contextType:r.contextType})))}}function U(e={}){return(t,n)=>{const o=n()
const i=o.images[o.contextType]
if(!(null!==i&&void 0!==i&&i.isLoading)&&null!==i&&void 0!==i&&i.hasMore){t(F(o.contextType))
return t(N(e))}}}function $(e={}){return(t,n)=>{const o=n()
t(R(o.contextType))
return t(N(e))}}var H=n("LixQ")
var W=n("n/1O")
const q="action.files.add_file"
const V="action.files.add_folder"
const G="action.files.receive_files"
const K="action.files.insert_file"
const Z="action.files.receive_subfolders"
const Y="action.files.request_files"
const J="action.files.request_subfolders"
const X="action.files.toggle"
const Q="action.files.set_root"
function ee(e){return{type:X,id:e}}function te({id:e,name:t,url:n,type:o,embed:i}){return{type:q,id:e,name:t,url:n,embed:i,fileType:o}}function ne(e){return{type:Y,id:e}}function oe(e,t){return{type:G,id:e,fileIds:t.map(e=>e.id)}}function ie(e,t){return{type:K,id:e,fileId:t}}function re(e,t){return(n,o)=>{const i=o(),r=i.source,a=i.folders
n(ne(e))
return r.fetchFiles(t||a[e].filesUrl).then(({files:t,bookmark:o})=>{n(t.map(te).concat(oe(e,t)))
o&&n(re(e,o))})}}function ae(e){return{type:V,id:e.id,name:e.name,parentId:e.parentId,filesUrl:e.filesUrl,foldersUrl:e.foldersUrl}}function ce(e){return{type:J,id:e}}function se(e,t){return{type:Z,id:e,folderIds:t.map(e=>e.id)}}function le(e,t){return(n,o)=>{const i=o(),r=i.source,a=i.folders
n(ce(e))
return r.fetchPage(t||a[e].foldersUrl).then(({folders:t,bookmark:o})=>{n(t.map(ae).concat(se(e,t,o)))
o&&n(le(e,o))})}}function de(e){return(t,n)=>{t(ee(e))
const o=n().folders[e]
if(!o.requested&&o.expanded){t(le(o.id))
t(re(o.id))}}}var ue=n("s54W")
var xe=n("rCsd")
var _e=n("kyQv")
var me=n("qScw")
var pe=n("9dNb")
const fe="COMPLETE_FILE_UPLOAD"
const he="FAIL_FILE_UPLOAD"
const ye="FAIL_FOLDERS_LOAD"
const be="FAIL_MEDIA_UPLOAD"
const ge="MEDIA_UPLOAD_SUCCESS"
const ve="PROCESSED_FOLDER_BATCH"
const we="QUOTA_EXCEEDED_UPLOAD"
const ke="RECEIVE_FOLDER"
const Ce="START_FILE_UPLOAD"
const Oe="START_LOADING"
const Ee="START_MEDIA_UPLOADING"
const Ae="STOP_LOADING"
const Se="STOP_MEDIA_UPLOADING"
const je="TOGGLE_UPLOAD_FORM"
function Ie(){return{type:Oe}}function Te(){return{type:Ae}}function Le({id:e,name:t,parentId:n}){return{type:ke,id:e,name:t,parentId:n}}function Be(e){return{type:ye,error:e}}function De(e){l["a"].showError(e)
return{type:be,error:e}}function Re(){return{type:ge}}function Fe(e){return{type:Ce,file:e}}function Me(e){return{type:he,error:e}}function ze(e){return{type:we,error:e}}function Pe(e){return{type:fe,results:e}}function Ne(){return{type:je}}function Ue({folders:e}){return{type:ve,folders:e}}function $e(e){return{type:Ee,payload:e}}function He(){return{type:Se}}function We(e){return t=>{t($e(e))
l["a"].insertImagePlaceholder(e)}}function qe(e){return t=>{t(He())
l["a"].removePlaceholders(e)}}function Ve(e,t,n){const o=[]
o.push(Pe(e))
const i={id:e.id,name:e.display_name,url:e.preview_url,type:t.contentType,embed:Object(ue["a"])(e)}
o.push(te(i))
o.push(ie(t.parentFolderId,e.id));/^image\//.test(e["content-type"])&&o.push(D(e,n))
return o}function Ge(e,t){const n=Object(ue["a"])(e)
if("images"===t&&Object(_e["d"])(n.type)&&"link"!==e.displayAs){var o,r
...
l["a"].insertImage(t)}else if("media"===t&&Object(_e["c"])(n.type)){var a,c
null===(a=l["a"].activeEditor())||void 0===a||null===(c=a.mceInstance())||void 0===c||c.selection.collapse()
l["a"].embedMedia({id:e.id,embedded_iframe_url:e.embedded_iframe_url,href:e.href||e.url,media_id:e.media_id,title:e.title,type:n.type,contextType:e.contextType,contextId:e.contextId,uuid:e.uuid})}else l["a"].insertLink({"data-canvas-previewable":Object(xe["a"])(e["content-type"]),href:e.href||e.url,title:e.alt_text||e.display_name||e.name||e.title||e.filename,content_type:e["content-type"],embed:Object(i["a"])(Object(i["a"])({},n),{},{disablePreview:true}),target:"_blank",contextType:e.contextType,contextId:e.contextId,uuid:e.uuid},false)
return e}function Ke(e){return(t,n)=>{t(Ie())
const o=n(),i=o.source,r=o.jwt,a=o.upload,c=o.host,s=o.contextId,l=o.contextType
if(e||a.folders&&0===Object.keys(a.folders).length)return i.fetchFolders({jwt:r,host:c,contextId:s,contextType:l},e).then(({folders:e,bookmark:o})=>{t(e.map(Le))
const i=n(),r=i.upload
t(Ue(r))
t(o?Ke(o):Te())}).catch(e=>{t(Be(e))})}}function Ze(e,t){const n=t||{},o=n.mediaObject,i=n.uploadedFile
return t=>{if(e){t(De(e))
t(qe(null===i||void 0===i?void 0:i.name))}else{const e={embedded_iframe_url:o.embedded_iframe_url,media_id:o.media_object.media_id,type:i.type,title:i.title||i.name}
t(qe(i.name))
Ge(e,"media")
t(Re())}}}function Ye(){return(e,t)=>{const n=t(),o=n.source
if(!l["a"].mediaServerSession)return o.mediaServerSession().then(e=>{l["a"].setMediaServerSession(e)})}}function Je(e,t={}){return(n,o)=>{const i=o(),r=i.source,a=i.jwt,c=i.host,s=i.contextId,l=i.contextType
...
return r.preflightUpload(x,{host:c,contextId:s,contextType:l,onDuplicate:d,category:S["c"]}).then(e=>r.uploadFRD(u,e))})}}function Xe(e,t){return(n,o)=>{var r
...
if("media"===e&&t.domObject)return Object(H["a"])(t.domObject,{contextId:_,contextType:m,origin:Object(W["c"])(x),headers:Object(W["b"])(u)},(e,t)=>{n(Ze(e,t))})
...
n(rt(e,Object(i["a"])(Object(i["a"])({},t),{},{bookmark:c})))}).catch(e=>{n(qe(t.name))
console.error("Fetching the media folder failed.",e)})}}function Qe(e,t,n){const o=t.usageRights
o&&e.setUsageRights(n.id,o)
return n}function et(e,t){if(t.href||t.url)return Promise.resolve(t)
return e.getFile(t.id).then(e=>{t.url=e.url
return t})}function tt(e,t=new FileReader){return new Promise((n,o)=>{t.onerror=()=>{t.abort()
o(new DOMException("Unable to parse file"))}
t.onload=()=>{n(t.result)}
t.readAsDataURL(e)})}function nt(e,t,n){return/^image\//.test(e["content-type"])?tt(t,n).then(t=>{e.thumbnail_url=t
return e}):Promise.resolve(e)}function ot(e,t){e&&(t.alt_text=e)
return t}function it(e,t){if(e&&e.response)return e.response.json().then(n=>{"file size exceeds quota"===n.message?t(ze(e)):t(Me(e))}).catch(e=>t(Me(e)))
if(e)return Promise.resolve().then(()=>t(Me(e)))}function rt(e,t){return(n,o)=>{const r=o(),a=r.source,c=r.jwt,s=r.host,d=r.contextId,u=r.contextType
const x=t.fileReader
n(Fe(t))
return(async e=>{const t=await pe["a"](e.domObject)
return null===t||void 0===t?void 0:t.category})(t).then(o=>a.preflightUpload(t,{jwt:c,host:s,contextId:d,contextType:u,category:o}).then(e=>a.uploadFRD(t.domObject,e)).then(e=>Qe(a,t,e)).then(e=>et(a,e)).then(e=>Object(me["b"])(u,d,e)).then(e=>nt(e,t.domObject,x)).then(e=>ot(t.altText,e)).then(e=>{t.isDecorativeImage&&(e.isDecorativeImage=t.isDecorativeImage)
t.displayAs&&(e.displayAs=t.displayAs)
return e}).then(e=>{n(qe(t.name))
return e}).then(n=>{let o
const r=l["a"].activeEditor()
if(t.bookmark){o=r.editor.selection.getBookmark(2,true)
r.editor.selection.moveToBookmark(t.bookmark)}const a=Ge(Object(i["a"])({contextType:u,contextId:d},n),e)
t.bookmark&&r.editor.selection.moveToBookmark(o)
return a}).then(e=>{n(Ve(e,t,u))}).catch(e=>{n(qe(t.name))
it(e,n)}))}}const at="START_FLICKR_SEARCH"
const ct="RECEIVE_FLICKR_RESULTS"
const st="FAIL_FLICKR_SEARCH"
const lt="TOGGLE_FLICKR_FORM"
function dt(e){return{type:at,term:e}}function ut(e){return{type:ct,results:e}}function xt(e){return{type:st,error:e}}function _t(){return{type:lt}}function mt(e){return(t,n)=>{const o=n(),i=o.source,r=o.host,a=o.flickr
if(a&&!a.searching){t(dt(e))
return i.searchFlickr(e,{host:r}).then(e=>t(ut(e))).catch(e=>t(xt(e)))}}}const pt="TOGGLE_NEWPAGE_FORM"
function ft(){return{type:pt}}const ht="REQUEST_INITIAL_DOCS"
const yt="REQUEST_NEXT_DOCS"
const bt="RECEIVE_DOCS"
const gt="FAIL_DOCS"
function vt(e){return{type:ht,payload:{contextType:e}}}function wt(e){return{type:yt,payload:{contextType:e}}}function kt({response:e,contextType:t,contextId:n}){const o=e.files,i=e.bookmark
return{type:bt,payload:{files:o,bookmark:i,contextType:t,contextId:n}}}function Ct({error:e,contextType:t}){return{type:gt,payload:{error:e,contextType:t}}}function Ot(){return(e,t)=>{const n=t()
return n.source.fetchDocs(n).then(t=>e(kt({response:t,contextType:n.contextType,contextId:n.contextId}))).catch(t=>e(Ct({error:t,contextType:n.contextType})))}}function Et(){return(e,t)=>{const n=t()
const o=n.documents[n.contextType]
if(!(null!==o&&void 0!==o&&o.isLoading)&&null!==o&&void 0!==o&&o.hasMore){e(wt(n.contextType))
return e(Ot())}}}function At(){return(e,t)=>{const n=t()
e(vt(n.contextType))
return e(Ot())}}var St=n("eAGa")
var jt=n("NFDp")
const It="REQUEST_INITIAL_MEDIA"
const Tt="REQUEST_MEDIA"
const Lt="RECEIVE_MEDIA"
const Bt="FAIL_MEDIA"
function Dt(e){return{type:It,payload:{contextType:e}}}function Rt(e){return{type:Tt,payload:{contextType:e}}}function Ft({response:e,contextType:t}){const n=e.files,o=e.bookmark
return{type:Lt,payload:{files:n,bookmark:o,contextType:t}}}function Mt({error:e,contextType:t}){return{type:Bt,payload:{error:e,contextType:t}}}function zt(){return(e,t)=>{const n=t()
e(Rt(n.contextType))
return n.source.fetchMedia(n).then(t=>e(Ft({response:t,contextType:n.contextType}))).catch(t=>e(Mt({error:t,contextType:n.contextType})))}}function Pt(){return(e,t)=>{const n=t()
const o=n.media[n.contextType]
if(!(null!==o&&void 0!==o&&o.isLoading)&&null!==o&&void 0!==o&&o.hasMore){e(Rt(n.contextType))
return e(zt())}}}function Nt(){return(e,t)=>{const n=t()
e(Dt(n.contextType))
return e(zt())}}function Ut({media_object_id:e,title:t,subtitles:n}){return(o,i)=>{const r=i()
const a=r.source.updateMediaObject(r,{media_object_id:e,title:t}).catch(e=>{St["a"].handleAlert({text:Object(jt["a"])("Though your video will have the correct title in the browser, we failed to update it in the database."),variant:"error"})
throw e})
const c=r.source.updateClosedCaptions(r,{media_object_id:e,subtitles:n})
return Promise.all([a,c])}}const $t="CHANGE_CONTEXT"
const Ht="CHANGE_CONTEXT_TYPE"
const Wt="CHANGE_CONTEXT_ID"
const qt="CHANGE_SEARCH_STRING"
const Vt="CHANGE_SORT_BY"
function Gt({contextType:e,contextId:t}){return n=>{n(Kt(e))
n(Zt(t))
n({type:$t,payload:{contextType:e,contextId:t}})}}function Kt(e){return{type:Ht,payload:e}}function Zt(e){return{type:Wt,payload:e}}function Yt(e){return{type:qt,payload:e}}function Jt(e){return{type:Vt,payload:e}}const Xt="ALL_FILES_LOADING"
function Qt(e){return{type:Xt,payload:e}}const en="action.session.receive_session"
function tn(e){return{type:en,data:e}}function nn(e,t){var n
const o=t(),i=o.source
return null===(n=i.getSession)||void 0===n?void 0:n.call(i).then(t=>e(tn(t)))}const on="uncategorized"
function rn(e){return{loadSession:()=>e(nn),onChangeTab:t=>e(p(t)),onChangeAccordion:t=>e(f(t)),fetchInitialPage:t=>e(A(t)),fetchNextPage:t=>e(E(t)),toggleFolder:t=>e(de(t)),fetchFolders:()=>e(Ke()),fetchInitialImages:(t={category:on})=>e($(t)),fetchNextImages:(t={category:on})=>e(U(t)),startUpload:(t,n)=>e(rt(t,n)),flickrSearch:t=>e(mt(t)),toggleFlickrForm:()=>e(_t()),toggleUploadForm:()=>e(Ne()),toggleNewPageForm:()=>e(ft()),startButtonsAndIconsUpload:(t,n)=>e(Je(t,n)),startMediaUpload:(t,n)=>e(Xe(t,n)),createMediaServerSession:()=>e(Ye()),mediaUploadComplete:(t,n)=>e(Ze(t,n)),fetchInitialDocs:()=>e(At()),fetchNextDocs:()=>e(Et()),fetchInitialMedia:()=>e(Nt()),fetchNextMedia:()=>e(Pt()),updateMediaObject:t=>e(Ut(t)),onChangeContext:t=>e(Gt(t)),onChangeSearchString:t=>e(Yt(t)),onChangeSortBy:t=>e(Jt(t)),onAllFilesLoading:t=>e(Qt(t))}}function an(e){const t=e.ui,n=e.containingContext,o=e.contextType,r=e.contextId,a=e.files,c=e.images,s=e.documents,l=e.media,d=e.folders,u=e.rootFolderId,x=e.flickr,_=e.upload,m=e.session,p=e.newPageLinkExpanded,f=e.all_files,h=e.jwt,y=e.host,b=e.source
const g={}
for(const t in e.collections){const n=e.collections[t]
g[t]=n}return Object(i["a"])(Object(i["a"])({containingContext:n,contextType:o,contextId:r,collections:g,files:a,images:c,documents:s,media:l,folders:d,rootFolderId:u,flickr:x,upload:_,session:m,newPageLinkExpanded:p},t),{},{all_files:f,jwt:h,host:y,source:b})}var cn=n("ANjH")
var sn=function(e=""){return e}
function ln(e=false,t){switch(t.type){case _:return true
case x:case m:return false
default:return e}}function dn(e=0,t){switch(t.type){case x:return 0
case d:return t.index
default:return e}}function un(e="",t){switch(t.type){case x:case d:return""
case u:return t.index
default:return e}}var xn=Object(cn["combineReducers"])({hidden:ln,selectedTabIndex:dn,selectedAccordionIndex:un})
var _n=function(e={},t){switch(t.type){case h:return Object(i["a"])(Object(i["a"])({},e),{},{links:[],bookmark:null,isLoading:true,hasMore:true,searchString:t.searchString})
...
function mn(e){return function(t={},n){switch(n.type){case h:case y:case b:case g:return n.key===e?_n(t,n):t
default:return t}}}var pn=Object(cn["combineReducers"])({announcements:mn("announcements"),assignments:mn("assignments"),discussions:mn("discussions"),modules:mn("modules"),quizzes:mn("quizzes"),wikiPages:mn("wikiPages")})
function fn(e={},t){switch(t.type){case q:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:{id:t.id,name:t.name,type:t.fileType,url:t.url,embed:t.embed}})
default:return e}}const hn={id:null,name:null,loadingCount:0,loading:false,requested:false,expanded:false,filesUrl:null,foldersUrl:null,parentId:null,fileIds:[],folderIds:[]}
function yn(e=hn,t){let n
switch(t.type){case V:return Object(i["a"])(Object(i["a"])({},e),{},{id:t.id,name:t.name,parentId:t.parentId,filesUrl:t.filesUrl,foldersUrl:t.foldersUrl})
case G:n=e.loadingCount-1
return Object(i["a"])(Object(i["a"])({},e),{},{loadingCount:n,loading:!!n,fileIds:e.fileIds.concat(t.fileIds)})
case K:return Object(i["a"])(Object(i["a"])({},e),{},{fileIds:e.fileIds.concat(t.fileId)})
case Z:n=e.loadingCount-1
return Object(i["a"])(Object(i["a"])({},e),{},{loadingCount:n,loading:!!n,folderIds:e.folderIds.concat(t.folderIds)})
case Y:case J:n=e.loadingCount+1
return Object(i["a"])(Object(i["a"])({},e),{},{requested:true,loadingCount:n,loading:!!n})
case X:return Object(i["a"])(Object(i["a"])({},e),{},{expanded:!e.expanded})
default:return e}}function bn(e={},t){switch(t.type){case V:case G:case K:case Z:case Y:case J:case X:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:yn(e[t.id],t)})
default:return e}}function gn(e=null,t){switch(t.type){case Q:return t.id
default:return e}}function vn(e={},t){const n=t.payload&&t.payload.contextType
const o=Object(i["a"])({},e)
n&&!o[n]&&(o[n]={files:[],bookmark:null,isLoading:false,hasMore:true})
switch(t.type){case j:{const e=t.payload.newImage,i=e.id,r=e.filename,a=e.display_name,c=e.href,s=e.preview_url,l=e.thumbnail_url
o[n]={files:o[n].files.concat({id:i,filename:r,display_name:a,preview_url:s,thumbnail_url:l,href:s||c})}
return o}case I:o[n]={files:[],bookmark:null,isLoading:true,hasMore:true}
return o
case T:o[n].isLoading=true
return o
case L:t.payload.searchString===o.searchString&&(o[n]={files:o[n].files.concat(t.payload.files),isLoading:false,bookmark:t.payload.bookmark,hasMore:!!t.payload.bookmark})
return o
case B:o[n]={isLoading:false,error:t.payload.error,files:[]}
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case $t:return o
case qt:o.searchString=t.payload
return o
default:return e}}function wn(e={},t){const n=t.payload&&t.payload.contextType
const o=Object(i["a"])({},e)
n&&!o[n]&&(o[n]={files:[],bookmark:null,isLoading:false,hasMore:true})
switch(t.type){case ht:o[n]={files:[],bookmark:null,isLoading:true,hasMore:true}
return o
case yt:o[n].isLoading=true
return o
...
return o
case gt:o[n]={isLoading:false,error:t.payload.error}
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case $t:case qt:return o
default:return e}}function kn(e={},t){const n=t.payload&&t.payload.contextType
const o=Object(i["a"])({},e)
n&&!o[n]&&(o[n]={files:[],bookmark:null,isLoading:false,hasMore:true})
switch(t.type){case It:o[n]={files:[],bookmark:null,isLoading:true,hasMore:true}
return o
case Tt:o[n].isLoading=true
return o
case Lt:o[n]={files:o[n].files.concat(t.payload.files),bookmark:t.payload.bookmark,isLoading:false,hasMore:!!t.payload.bookmark}
return o
case Bt:o[n]={isLoading:false,error:t.payload.error}
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case $t:case qt:return o
default:return e}}function Cn(e=false,t){switch(t.type){case Ce:return true
case he:case fe:case we:return false
default:return e}}function On(e={},t){switch(t.type){case fe:return{}
case we:return Object(i["a"])(Object(i["a"])({},e),{},{type:t.type})
default:return e}}function En(e=false,t){switch(t.type){case fe:return false
case je:return!e
default:return e}}function An(e={},t){switch(t.type){case ke:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:{id:t.id,name:t.name,parentId:t.parentId}})
case ye:default:return e}}function Sn(e=null,t){switch(t.type){case ke:return null===t.parentId?t.id:e
default:return e}}function jn(e={},t){switch(t.type){case ve:{const e=t.folders
const n={}
for(const t in e){const o=e[t]
n[o.id]=n[o.id]||[]
if(o.parentId){n[o.parentId]=n[o.parentId]||[]
n[o.parentId].push(o.id)}}for(const t in n){const o=n[t]
o.sort((t,n)=>e[t].name.localeCompare(e[n].name))}return n}default:return e}}function In(e=false,t){switch(t.type){case Oe:return true
case Ae:case ye:return false
default:return e}}function Tn(e=false,t){switch(t.type){case Oe:return{loading:true,uploaded:false,error:false}
case be:return{loading:false,uploaded:false,error:true}
case ge:return{loading:false,uploaded:true,error:false}
default:return e}}var Ln=Object(cn["combineReducers"])({uploading:Cn,formExpanded:En,folders:An,rootFolderId:Sn,folderTree:jn,error:On,loadingFolders:In,uploadingMediaStatus:Tn})
var Bn=function(e={},t){switch(t.type){case at:return Object(i["a"])(Object(i["a"])({},e),{},{searching:true,searchTerm:t.term})
case ct:return Object(i["a"])(Object(i["a"])({},e),{},{searching:false,searchResults:t.results})
case st:return Object(i["a"])(Object(i["a"])({},e),{},{searching:false,searchTerm:"",searchResults:[]})
case lt:return Object(i["a"])(Object(i["a"])({},e),{},{formExpanded:!e.formExpanded})
default:return e}}
const Dn={}
function Rn(e=Dn,t){switch(t.type){case en:return Object(i["a"])(Object(i["a"])({},e),t.data)
default:return e}}var Fn=function(e=false,t){switch(t.type){case pt:return!e
default:return e}}
function Mn(e="",t){if(t.type===Ht)return t.payload
return e}function zn(e="",t){if(t.type===Wt)return t.payload
return e}function Pn(e="",t){if(t.type===qt)return t.payload
return e}function Nn(e={order:"desc",sort:"date_added"},t){if(t.type===Vt)return t.payload
return e}function Un(e={},t){if(t.type===Xt)return Object(i["a"])(Object(i["a"])({},e),{},{isLoading:t.payload})
return e}var $n=Object(cn["combineReducers"])({ui:xn,source:sn,jwt:sn,host:sn,containingContext:sn,contextType:Mn,contextId:zn,searchString:Pn,sortBy:Nn,all_files:Un,collections:pn,files:fn,folders:bn,rootFolderId:gn,images:vn,documents:wn,media:kn,upload:Ln,flickr:Bn,session:Rn,newPageLinkExpanded:Fn})
function Hn(e){switch(e){case"course":case"courses":return"course"
case"group":case"groups":return"group"
case"user":case"users":return"user"
default:return}}var Wn=function(e={}){let t=e,n=t.source,o=t.jwt,r=t.refreshToken,a=t.host,c=t.contextType,s=t.contextId,l=t.collections,d=t.files,u=t.folders,x=t.upload,_=t.images,m=t.documents,p=t.media,f=t.flickr,h=t.newPageLinkExpanded,y=t.searchString,b=t.sortBy,g=t.all_files
c=Hn(c)
...
null==n&&(n=new W["a"]({jwt:o,refreshToken:r,host:a}))
...
var qn=n("sINF")
var Vn=n("FkO2")
var Gn=function(e,t){const n=Object(cn["createStore"])(Object(Vn["batching"])($n),t||Wn(e),Object(cn["applyMiddleware"])(qn["a"],Vn["batch"]))
...
return n}
const Kn=["children"],Zn=["children"]
function Yn(e){let t=e.children,n=Object(r["a"])(e,Kn)
return t(Object(i["a"])({onLinkClick:l["a"].insertLink,onImageEmbed:l["a"].embedImage,onMediaEmbed:l["a"].embedMedia,onFileSelect:l["a"].insertFileLink},n))}const Jn=Object(s["b"])(an,rn)(Yn)
const Xn=Object(a["createContext"])()
function Qn(e){let t=e.children,n=Object(r["a"])(e,Zn)
const i=Object(a["useState"])(()=>Gn(n)),l=Object(o["a"])(i,1),d=l[0]
return c.a.createElement(s["a"],{store:d},c.a.createElement(Jn,null,e=>c.a.createElement(Xn.Provider,{value:e},t(e))))}function eo(){const e=Object(a["useContext"])(Xn)
...
n.d(t,"a",(function(){return o}))
function o(e){const t=new Promise((t,o)=>{n.e(28).then(n.t.bind(null,"9Uei",7)).then(()=>{let i
switch(e){case"ar":i=n.e(4184).then(n.bind(null,"venI"))
break
case"ca":i=n.e(4185).then(n.bind(null,"1Y6O"))
break
case"cy":i=n.e(4186).then(n.bind(null,"we+z"))
break
case"da":i=n.e(4188).then(n.bind(null,"PTiq"))
break
case"da-x-k12":i=n.e(4187).then(n.bind(null,"yNIZ"))
break
case"de":i=n.e(4189).then(n.bind(null,"S8cF"))
break
case"el":i=n.e(4190).then(n.bind(null,"FwcW"))
break
case"en":i=n.e(4262).then(n.bind(null,"NQfO"))
break
case"en-AU-x-unimelb":i=n.e(4191).then(n.bind(null,"3W0S"))
break
case"en-GB-x-ukhe":i=n.e(4192).then(n.bind(null,"KQzV"))
break
case"en-AU":i=n.e(4193).then(n.bind(null,"voS+"))
break
case"en-CA":i=n.e(4263).then(n.bind(null,"m+Mn"))
break
case"en-CY":i=n.e(4264).then(n.bind(null,"mgnU"))
break
case"en-GB":i=n.e(4194).then(n.bind(null,"nxzM"))
break
case"es":i=n.e(4195).then(n.bind(null,"2MaM"))
break
case"es-ES":i=n.e(4196).then(n.bind(null,"HM1o"))
break
case"fa-IR":i=n.e(4197).then(n.bind(null,"01hr"))
break
case"fi":i=n.e(4198).then(n.bind(null,"QFVQ"))
break
case"fr":i=n.e(4199).then(n.bind(null,"8o6s"))
break
case"fr-CA":i=n.e(4200).then(n.bind(null,"Bm8W"))
break
case"he":i=n.e(4201).then(n.bind(null,"mYM8"))
break
case"ht":i=n.e(4265).then(n.bind(null,"ZkKP"))
break
case"hu":i=n.e(4202).then(n.bind(null,"sbbs"))
break
case"hy":i=n.e(4203).then(n.bind(null,"WoYt"))
break
case"is":i=n.e(4266).then(n.bind(null,"/C+o"))
break
case"it":i=n.e(4204).then(n.bind(null,"Qvrh"))
break
case"ja":i=n.e(4205).then(n.bind(null,"XZYX"))
break
case"ko":i=n.e(4206).then(n.bind(null,"vrKU"))
break
case"mi":i=n.e(4267).then(n.bind(null,"LP6z"))
break
case"nb":i=n.e(4208).then(n.bind(null,"Uc+e"))
break
case"nb-x-k12":i=n.e(4207).then(n.bind(null,"56N6"))
break
case"nl":i=n.e(4209).then(n.bind(null,"17Or"))
break
case"nn":i=n.e(4210).then(n.bind(null,"HZtm"))
break
case"pl":i=n.e(4211).then(n.bind(null,"JcWQ"))
break
case"pt":i=n.e(4212).then(n.bind(null,"I9Ke"))
break
case"pt-BR":i=n.e(4213).then(n.bind(null,"7P9b"))
break
case"ru":i=n.e(4214).then(n.bind(null,"V5X0"))
break
case"se":i=n.e(4268).then(n.bind(null,"JKpP"))
break
case"sl":i=n.e(4215).then(n.bind(null,"h8aU"))
break
case"sv":i=n.e(4217).then(n.bind(null,"lfo/"))
break
case"sv-x-k12":i=n.e(4216).then(n.bind(null,"4MO5"))
break
case"th":i=n.e(4218).then(n.bind(null,"TDbP"))
break
case"tr":i=n.e(4219).then(n.bind(null,"V0pu"))
break
case"uk-UA":i=n.e(4220).then(n.bind(null,"yL5t"))
break
case"vi":i=n.e(4221).then(n.bind(null,"rGya"))
break
case"zh":i=n.e(4224).then(n.bind(null,"Sx0h"))
break
case"zh-Hans":i=n.e(4222).then(n.bind(null,"32vL"))
break
case"zh-Hant":i=n.e(4223).then(n.bind(null,"Iyx8"))
break
case"zh-HK":i=n.e(4225).then(n.bind(null,"v1QM"))
break
...
default:return Object(m["a"])("Tray")}}const N={buttons_and_icons:a.a.lazy(()=>Promise.all([n.e(15),n.e(102),n.e(4149)]).then(n.bind(null,"F/nJ"))),links:a.a.lazy(()=>n.e(4106).then(n.bind(null,"2k/U"))),images:a.a.lazy(()=>Promise.all([n.e(15),n.e(102),n.e(4159)]).then(n.bind(null,"ZXxL"))),documents:a.a.lazy(()=>n.e(4115).then(n.bind(null,"3R0a"))),media:a.a.lazy(()=>n.e(4116).then(n.bind(null,"bfKp"))),all:a.a.lazy(()=>Promise.all([n.e(30),n.e(82),n.e(96),n.e(4260)]).then(n.bind(null,"NhNB"))),unknown:a.a.lazy(()=>n.e(4261).then(n.bind(null,"G/Kj")))}
function U(e){let t=""
...
//# sourceMappingURL=35-c-42ca726a67.js.map